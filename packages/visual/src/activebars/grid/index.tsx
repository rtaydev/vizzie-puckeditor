...
const GridActionBar = ({
	...
	return (
		<ActionBar label={label}>
			...
			{isGridBlock && (
				<ActionBar.Group>
					<ActionBar.Action onClick={handleRemoveColumn} label='Remove column'>
						<Minus
							size={14}
							style={{ opacity: currentColumns <= 1 ? 0.5 : 1, color: 'white' }}
						/>
					</ActionBar.Action>
					<span style={{ fontSize: '12px', color: 'white', padding: '0 8px' }}>
						{currentColumns} cols
					</span>
